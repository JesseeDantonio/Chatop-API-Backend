package fr.jessee.chatop.security;

import fr.jessee.chatop.feature.JsonWebToken;
import fr.jessee.chatop.security.filter.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/login", "/api/auth/register", "uploads/**", "/v3/api-docs/**",
                                "/swagger-ui/**",
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowCredentials(true); // optionnel
